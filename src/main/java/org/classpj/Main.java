...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        for (String ensembleType : ensembleMethods) {
            System.out.println("\n" + "=".repeat(80));
            ImprovedClassifiers improved = new ImprovedClassifiers(ensembleType, "J48");
